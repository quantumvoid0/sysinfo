...
int main(int argc, char **argv) {
	if (argc < 2) {
		...
		printf(
		    "  editor   : editor name (only if $EDITOR var is set)\n");
		...
		printf(
		    "  version-latest : latest available sysinfo version\n\n");
	...
	if (strcmp(argv[1], "host") == 0 || strcmp(argv[1], "hostname") == 0 ||
	...
	if (strcmp(argv[1], "cpucores") == 0 || strcmp(argv[1], "cores") == 0 ||
	    strcmp(argv[1], "core") == 0 || strcmp(argv[1], "cpucore") == 0) {
		cpucores();
	};
	if (strcmp(argv[1], "cpufreq") == 0 || strcmp(argv[1], "freq") == 0 ||
